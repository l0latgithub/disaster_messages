...
### Descriptions
  A web app was built with Natural Language Process(NLP) model to classify disaster messages or tweets. Emergency response team could use this tool to determine how to respond during an disaster event.
